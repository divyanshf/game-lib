...
Menu::Menu(SDL_Renderer* ren, SDL_Window* win, std::string username) {
	...
	questionFont = TTF_OpenFont("Resources/Fonts/Montserrat/MontserratLight-ywBvq.ttf", 24);
	optionFont = TTF_OpenFont("Resources/Fonts/Montserrat/MontserratLight-ywBvq.ttf", 18);
	instructionFont = TTF_OpenFont("Resources/Fonts/Montserrat/MontserratLight-ywBvq.ttf", 16);

	//	Initialize options
	list.push_back(tupleStr("TIC-TAC-TOE", "Resources/Assets/GameImage/Tic.png"));
	list.push_back(tupleStr("PONG", "Resources/Assets/GameImage/Pong.png"));
	list.push_back(tupleStr("HANGMAN", "Resources/Assets/GameImage/HangMan.png"));
	list.push_back(tupleStr("SNAKE", "Resources/Assets/GameImage/Snake.png"));
	list.push_back(tupleStr("FLAPPY BIRD", "Resources/Assets/GameImage/Flappy.png"));
	list.push_back(tupleStr("EXIT", "Resources/Assets/GameImage/Exit.png"));
