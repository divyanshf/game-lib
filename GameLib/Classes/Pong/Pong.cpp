...
Pong::Pong(SDL_Renderer* ren, SDL_Window* win, std::string username) {
	...
	collideEffect = Mix_LoadWAV("Resources/Audio/Collide.wav");
	...
	wallEffect = Mix_LoadWAV("Resources/Audio/Click.wav");
